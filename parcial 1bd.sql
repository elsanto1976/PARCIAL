---Create a tablespace called "COURSES" with two datafiles each one of 50Mb,
...
CREATE USER elsanto1976 IDENTIFIED BY elsanto1976
DEFAULT TABLESPACE  COURSES
PROFILE ADMIN
TEMPORARY TABLESPACE TEMP
QUOTA UNLIMITED ON COURSES;

GRANT CONNECT, RESOURCE TO elsanto1976;
GRANT DBA TO elsanto1976;

--Create 4 tables (LOG IN WITH YOUR USER!!!!!):
--COURSES(id, name, code, date_start, date_end) STUDENTS
--(id, first_name, last_name, date_of_birth, city, address)
